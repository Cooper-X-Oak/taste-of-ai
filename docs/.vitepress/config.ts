      ...
      '/seasons/s01/': [
        {
          ...
          items: [
            ...
            { text: 'EP01 · 调研搜索横评', link: '/seasons/s01/ep01-research' },
            { text: 'EP02 · 内容创作横评', link: '/seasons/s01/ep02-content' },
            { text: 'EP03 · 前端设计横评', link: '/seasons/s01/ep03-frontend' },
            { text: 'EP04 · 测试调试横评', link: '/seasons/s01/ep04-debug' },
            { text: 'EP05 · Skill·Agent 元治理横评', link: '/seasons/s01/ep05-meta' },
            { text: 'EP06 · 代码审查 & 开发流横评', link: '/seasons/s01/ep06-codedev' },
            { text: 'EP07 · 文档处理横评', link: '/seasons/s01/ep07-docs' },
