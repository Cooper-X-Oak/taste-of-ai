      ...
      '/seasons/s01/': [
        {
          ...
          items: [
            ...
            { text: 'EP04 · 测试调试擂台', link: '/seasons/s01/ep04-debug' },
            { text: 'EP05 · Skill·Agent 元治理擂台', link: '/seasons/s01/ep05-meta' },
            { text: 'EP06 · 代码审查 & 开发流擂台', link: '/seasons/s01/ep06-codedev' },
            { text: 'EP07 · 文档处理擂台', link: '/seasons/s01/ep07-docs' },
